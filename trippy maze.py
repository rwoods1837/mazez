...
while not done:
    ...
    rand_red = (random.randint(2, 255), 0, 0)
    rand_yellow = (random.randint(2, 255), random.randint(2,255), 0)
    rand_blue = (0, 0, random.randint(2, 255))
    rand_white = (random.randint(50, 255), random.randint(50, 255), random.randint(50, 255))
    ...
    screen.fill(rand_blue)

    pygame.draw.rect(screen, rand_white, player1)
    
    for w in walls:
        pygame.draw.rect(screen, rand_red, w)

    for c in coins:
        pygame.draw.rect(screen, rand_yellow, c)
